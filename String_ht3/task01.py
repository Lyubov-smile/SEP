...
#line 31    elif ord(i) == 33 or ord(i) == 34 or ord(i) == 39 or ord(i) == 40 or ord(i) == 41 or ord(i) == 44 or ord(i)
# == 45 or ord(i) == 46 or ord(i) == 58 or ord(i) == 59 or ord(i) == 63 or ord(i) == 91 or ord(i) == 93:
